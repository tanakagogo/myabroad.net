...
<head>
	<meta charset="utf-8">
	<title>MyAbroad | Trip Share! Photo Upload! | picquest/confirm</title>
...
<div class="inner height-setting3">
		<div id="form">
			<p class="form003"><a href="#caution">→アップロード前に注意事項をご確認ください</a></p>
			<form action="picquest_complete.php" method="post">
				<ul>
					<p>&#9312;下記ぴっクエストに問題なければ&#9313;へ。ここで修正することもできます。</p>
					<div class="form005">
						<table>
							<tr>
								<td id="kuchibashi" width="50px"></td>
								<td><textarea type="textarea" name="picquest" size="35"><?= $picquest; ?></textarea></td>
							</tr>
						</table>
					</div>
					<p>&#9313;いざっ、ぴっクエストを投稿</p>
