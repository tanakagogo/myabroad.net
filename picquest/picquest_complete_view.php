...
<head>
	<meta charset="utf-8">
	<title>MyAbroad | Trip Share! Photo Upload! | picquest/conplete</title>
	<link href="css/pq_comp_style.css" type="text/css" rel="stylesheet">
	<script>
...
<div class="inner height-setting">
			<div class="form005">
				<p><?= h($insert_comment); ?></p><br>
			</div>
			<a href="../index.php">トップページに戻る</a><br>
			<a href="../picquest/picquest.php">ぴっクエスト一覧に戻る</a><br>
</div><!-- class="inner" -->
